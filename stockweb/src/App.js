...
function App() {
  ...
  const createUser = () => {
    axios.post(` https://radiant-escarpment-24969.herokuapp.com/action/${username}`);
  }

  //update month
  const getMon = () => {
    axios.get(` https://radiant-escarpment-24969.herokuapp.com/month/`).then(res => setMonth(res.data.month));
  }

  useEffect(() => getMon());

  const getYr = () => {
    axios.get(` https://radiant-escarpment-24969.herokuapp.com/year/`).then(res => setYear(res.data.year));
  }
  ...
  const getLimit = () => {
    axios.get(` https://radiant-escarpment-24969.herokuapp.com/getlimit/${username}`).then(res => setLimit(res.data.limit));
  }
  ...
  const getBalance = () => {
    axios.get(` https://radiant-escarpment-24969.herokuapp.com/getbalance/${username}`).then(res => setBalance(res.data.balance));
  }
  ...
  const updateLimit = (lim) => {
    axios.post(` https://radiant-escarpment-24969.herokuapp.com/updatelimit/${username}`, { lim: lim }).then(
      res => setLimit(lim)
    );
  }
  ...
  const getAllActions = () => {
    axios.get(` https://radiant-escarpment-24969.herokuapp.com/getallactions/${username}?month=${month}&year=${year}`).then(
  ...
  const getYearActions = () => {
    axios.get(` https://radiant-escarpment-24969.herokuapp.com/getallactions/${username}?year=${year}`).then(
  ...
  const makeTransaction = (desc, amnt, mon, day, yr, cat) => {
    axios.post(` https://radiant-escarpment-24969.herokuapp.com/maketransaction/${cat}?month=${month}&year=${year}`,
