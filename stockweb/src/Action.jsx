...
export default ({ loggedIn, handleLogout, createUser }) => {
    let firstName = null;
            ...
            <div>
                ...
                <div className="action-options">
                    <div className="option-input-expense">
                        ...
                        <Button id="option-input-button" variant="outline-dark"
                            href="/inputexpense" onClick={createUser}>
                            Input Expense</Button>
                    </div>
                    ...
                    <div className="option-manage-budget">
                        ...
                        <Button id="option-budget-button" variant="outline-dark"
                            href="/managebudget" onClick={createUser}>
